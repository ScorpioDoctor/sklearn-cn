...
.. topic:: 译者注
    ...
    数据集的API这块儿讲的挺详细的，下面我把当时讲课时自己制作的PPT和视频的链接地址放在这儿，希望大家喜欢。 
    (`Sklearn数据集操作API (一) <http://www.studyai.com/article/ddf094e18e834a95>`_) 
    (`视频 <http://www.studyai.com/course/play/6d472743b7d34283ad05e658fcc973fb>`_)；
    (`Sklearn数据集操作API (二) <http://www.studyai.com/article/ddf094e18e834a95>`_)，
    (`视频 <http://www.studyai.com/course/play/637b8339a23e48d19c0ff5bb9ae8a323>`_)；
    (`Sklearn数据集操作API (三) <http://www.studyai.com/article/dbb7ea7264784b11>`_)，
    (`视频 <http://www.studyai.com/course/play/ce5a1343ed334d198e1bd55941a1de95>`_)；
    (`Sklearn数据集操作API (四) <http://www.studyai.com/article/b82ea4b5ae084e8f>`_)
    (`视频 <http://www.studyai.com/course/play/092440b6edf3423483136630587918bb>`_)。
