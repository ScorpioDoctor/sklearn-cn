...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    RandomizedSearchCV took 7.47 seconds for 20 candidates parameter settings.
    Model with rank: 1
    ...
    GridSearchCV took 22.33 seconds for 72 candidate parameter settings.
    Model with rank: 1
...
**Total running time of the script:** ( 0 minutes  29.897 seconds)
